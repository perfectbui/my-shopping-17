...
export default function FindScreen(props) {
  ...
  useEffect(() => {
    const _character = props.match.params.character;
    dispatch(searchAction(_character,24*(numPage-1),120));
    return () => {};
  }, [numPage,props.match.params.character]);
  console.log(props);

  return (
    <div className="content">
      <ul className="products">
      {productSearch?productSearch.map((product,indexProduct) => {
